...
namespace UT.MailSample
{
    ...
    /// </summary>
    public class UTMailSample : MonoBehaviour
    {
        ...
        private const string DefaultSubject = "Visite immersive d'un client";
        private const string DefaultBody = "La gallerie Roberto STEPHENSON a été visitée par:" ;

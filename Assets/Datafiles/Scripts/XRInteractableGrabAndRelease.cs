...
//Make sure the Input is configured in OpenVR for the Trigger

public class XRInteractableGrabAndRelease : MonoBehaviour
{
    ...
    void Grab()  //Grab colliding object (= Make it a child of the parent hand)
    {
        ...
        //Making the touched object kinematic so it does not fall
        m_CollidingObject.GetComponent<Rigidbody>().isKinematic = true;

        //Make it a child of our hand so that it moves with our hand

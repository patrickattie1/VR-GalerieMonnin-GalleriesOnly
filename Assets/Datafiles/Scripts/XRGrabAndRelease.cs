...
namespace GMGalleriesOnly
{
    ...
    //Note: If needed, deactivate the Cart's Mesh Renderer to make the Cart invisible while keeping its functionality
    public class XRGrabAndRelease : MonoBehaviour
    {
        ...
        void Release() //Release colliding object
        {
            ...
            m_CollidingObject.transform.SetParent(m_Cart.transform); //Complete version: make the grabbed sign a child of the Cart game object so that it moves with the cart
